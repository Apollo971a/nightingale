...
var I18N = `{
  ...
  "ar_AE": {
    "Username or password invalid": "اسم المستخدم أو كلمة المرور غير صالحة",
    "incorrect verification code": "رمز التحقق غير صحيح",
    "roles empty": "يجب عدم ترك الأدوار فارغة",
    "Username already exists": "اسم المستخدم موجود بالفعل، يرجى استخدام اسم آخر",
    "failed to count user-groups": "فشل التحقق من البيانات، يرجى المحاولة مرة أخرى",
    "UserGroup already exists": "اسم المجموعة موجود بالفعل، يرجى استخدام اسم آخر",
    "members empty": "يجب عدم ترك الأعضاء فارغين",
    "At least one team have rw permission": "يجب أن يمتلك فريق واحد على الأقل صلاحيات القراءة والكتابة",
    "Failed to create BusiGroup(%s)": "فشل إنشاء مجموعة الأعمال (%s)، يرجى المحاولة مرة أخرى",
    "business group id invalid": "معرف مجموعة الأعمال غير صحيح",
    "idents empty": "يجب عدم ترك كائنات المراقبة فارغة",
    "invalid tag(%s)": "الوسم (%s) غير صالح",
    "invalid tagkey(%s): cannot contains . ": "مفتاح الوسم (%s) لا يمكن أن يحتوي على .",
    "invalid tagkey(%s): cannot contains _ ": "مفتاح الوسم (%s) لا يمكن أن يحتوي على _",
    "invalid tagkey(%s)": "مفتاح الوسم (%s) غير صالح",
    "duplicate tagkey(%s)": "مفتاح الوسم (%s) مكرر",
    "name is empty": "الاسم فارغ",
    "Ident duplicate": "المعرف الفريد لوحة البيانات موجود بالفعل",
    "No such dashboard": "لوحة البيانات غير موجودة",
    "Name has invalid characters": "الاسم يحتوي على رموز غير صالحة",
    "Name is blank": "يجب عدم ترك الاسم فارغاً",
    "forbidden": "غير مسموح / لا توجد صلاحيات",
    "builtin alerts is empty, file: %s": "قوالب التنبيه المدمجة فارغة، الملف: %s",
    "input json is empty": "المحتوى المرسل فارغ",
    "fields empty": "يجب عدم ترك الحقول المختارة فارغة",
    "No such AlertRule": "قاعدة التنبيه غير موجودة",
    "GroupId(%d) invalid": "معرف مجموعة الأعمال (%d) غير صالح",
    "No such recording rule": "قاعدة التسجيل غير موجودة",
    "tags is blank": "يجب عدم ترك الوسوم فارغة",
    "oops... etime(%d) <= btime(%d)": "خطأ... وقت البدء لا يمكن أن يكون بعد وقت الانتهاء",
    "group_id invalid": "مجموعة الأعمال غير صالحة",
    "No such AlertMute": "قاعدة الحجب غير موجودة",
    "rule_id and tags are both blank": "لا يمكن ترك قاعدة التنبيه والوسوم فارغين معاً",
    "rule is blank": "القاعدة فارغة",
    "rule invalid": "القاعدة غير صالحة، يرجى التحقق من صحتها",
    "unsupported field: %s": "حقل غير مدعوم: %s",
    "arg(batch) should be nonnegative": "يجب أن تكون قيمة (حزمة) غير سالبة",
    "arg(tolerance) should be nonnegative": "يجب أن تكون قيمة (تسامح) غير سالبة",
    "arg(timeout) should be nonnegative": "يجب أن تكون قيمة (نفذ الوقت) غير سالبة",
    "arg(timeout) longer than five days": "يجب ألا تتجاوز مدة (نفذ الوقت) 5 أيام",
    "arg(title) is required": "العنوان (عنوان) مطلوب",
    "created task.id is zero": "معرف المهمة المنشأة هو صفر",
    "invalid ibex address: %s": "عنوان ibex غير صالح: %s",
    "url path invalid": "مسار الرابط (URL) غير صالح",
    "no such server": "الخادم غير موجود",
    "admin role can not be modified": "لا يمكن تعديل دور المسؤول (Admin)",
    "builtin payload already exists": "القالب المدمج موجود بالفعل",
    "This functionality has not been enabled. Please contact the system administrator to activate it.": "هذه الميزة غير مفعلة. يرجى الاتصال بمسؤول النظام لتفعيلها.",
    "targets not exist: %s": "بعض الأجهزة غير موجودة: %s",
    "mute is disabled": "قاعدة الحجب معطلة",
    "datasource id not match": "معرف مصدر البيانات غير متطابق",
    "event trigger time not within mute time range": "وقت تشغيل الحدث ليس ضمن نطاق وقت الحجب",
    "event trigger time not within periodic mute range": "وقت تشغيل الحدث ليس ضمن نطاق الحجب الدوري",
    "mute time type invalid": "نوع وقت الحجب غير صالح",
    "event severity not match mute severity": "مستوى خطورة الحدث لا يتطابق مع مستوى خطورة الحجب",
    "event tags not match mute tags": "وسوم الحدث لا تتطابق مع وسوم الحجب",
    "event datasource not match": "مصدر بيانات الحدث غير متطابق",
    "event rule id not match": "معرف قاعدة تنبيه الحدث غير متطابق",
    "event tags not match": "وسوم الحدث غير متطابقة",
    "event group name not match": "اسم مجموعة أعمال الحدث غير متطابق",
    "event severity not match": "مستوى خطورة الحدث غير متطابق",
    "subscribe notify rule not found: %v": "قاعدة إشعار الاشتراك غير موجودة: %v",
    "notify rule send error: %v": "خطأ في إرسال قاعدة الإشعار: %v",
    "event match subscribe and notification test ok": "الحدث يطابق قاعدة الاشتراك، واختبار الإشعار ناجح",
    "no notify rules selected": "لم يتم اختيار قواعد إشعار",
    "no notify channels selected": "لم يتم اختيار قنوات إشعار",
    "no notify groups selected": "لم يتم اختيار مجموعات إشعار",
    "all users missing notify channel configurations: %v": "جميع المستخدمين يفتقرون إلى إعدادات قنوات الإشعار: %v",
    "event match subscribe and notify settings ok": "الحدث يطابق قاعدة الاشتراك، وإعدادات الإشعار سليمة",
    "/loki suffix is miss, please add /loki to the url: %s": "لاحقة /loki مفقودة، يرجى إضافتها إلى الرابط: %s",

    "event time not match time filter": "وقت الحدث لا يطابق مرشح الوقت",
    "event severity not match severity filter": "مستوى خطورة الحدث لا يطابق مرشح الخطورة",
    "event tag not match tag filter": "وسم الحدث لا يطابق مرشح الوسوم",
    "event attributes not match attributes filter": "خصائص الحدث لا تطابق مرشح الخصائص",
    "failed to parse tag filter: %v": "فشل تحليل مرشح الوسوم: %v",

    "event is dropped": "تم تجاهل الحدث، لن يتم إرسال إشعار",
    "drop event success": "نجح تجاهل الحدث",
    "drop event failed": "فشل تجاهل الحدث",
    "callback success": "نجح الاستدعاء التلقائي (أتصل مرة أخرى)",

    "Infrastructure": "البنية التحتية",
    "Host - View": "الجهاز - عرض",
    "Host - Modify": "الجهاز - تعديل",
    "Host - Delete": "الجهاز - حذف",
    "Host - Bind Uncategorized": "الجهاز - ربط الأجهزة غير المصنفة بمجموعة أعمال",

    "Explorer": "مستكشف البيانات",
    "Metrics Explorer": "مستكشف المقاييس",
    "Quick View": "عرض سريع",
    "Built-in Metric - View": "المقاييس المدمجة - عرض",
    "Built-in Metric - Add": "المقاييس المدمجة - إضافة",
    "Built-in Metric - Modify": "المقاييس المدمجة - تعديل",
    "Built-in Metric - Delete": "المقاييس المدمجة - حذف",
    "Recording Rule - View": "قاعدة التسجيل - عرض",
    "Recording Rule - Add": "قاعدة التسجيل - إضافة",
    "Recording Rule - Modify": "قاعدة التسجيل - تعديل",
    "Recording Rule - Delete": "قاعدة التسجيل - حذف",
    "Logs Explorer": "مستكشف السجلات",
    "Index Pattern - View": "نمط الفهرس - عرض",
    "Index Pattern - Add": "نمط الفهرس - إضافة",
    "Index Pattern - Modify": "نمط الفهرس - تعديل",
    "Index Pattern - Delete": "نمط الفهرس - حذف",
    "Dashboard - View": "لوحة البيانات - عرض",
    "Dashboard - Add": "لوحة البيانات - إضافة",
    "Dashboard - Modify": "لوحة البيانات - تعديل",
    "Dashboard - Delete": "لوحة البيانات - حذف",
    "Dashboard - View Public": "لوحة البيانات - عرض اللوحات العامة",

    "Alerting": "التنبيهات",
    "Alerting Rule - View": "قاعدة التنبيه - عرض",
    "Alerting Rule - Add": "قاعدة التنبيه - إضافة",
    "Alerting Rule - Modify": "قاعدة التنبيه - تعديل",
    "Alerting Rule - Delete": "قاعدة التنبيه - حذف",
    "Mutting Rule - View": "قاعدة الحجب - عرض",
    "Mutting Rule - Add": "قاعدة الحجب - إضافة",
    "Mutting Rule - Modify": "قاعدة الحجب - تعديل",
    "Mutting Rule - Delete": "قاعدة الحجب - حذف",
    "Subscribing Rule - View": "قاعدة الاشتراك - عرض",
    "Subscribing Rule - Add": "قاعدة الاشتراك - إضافة",
    "Subscribing Rule - Modify": "قاعدة الاشتراك - تعديل",
    "Subscribing Rule - Delete": "قاعدة الاشتراك - حذف",
    "Self-healing-Script - View": "نصوص الإصلاح الذاتي - عرض",
    "Self-healing-Script - Add": "نصوص الإصلاح الذاتي - إضافة",
    "Self-healing-Script - Modify": "نصوص الإصلاح الذاتي - تعديل",
    "Self-healing-Script - Delete": "نصوص الإصلاح الذاتي - حذف",
    "Self-healing-Job - View": "مهام الإصلاح الذاتي - عرض",
    "Self-healing-Job - Add": "مهام الإصلاح الذاتي - إضافة",
    "Self-healing-Job - Modify": "مهام الإصلاح الذاتي - تعديل",
    "Active Event - View": "الأحداث النشطة - عرض",
    "Active Event - Delete": "الأحداث النشطة - حذف",
    "Historical Event - View": "الأحداث التاريخية - عرض",

    "Notification": "الإشعارات",
    "Notification Rule - View": "قاعدة الإشعار - عرض",
    "Notification Rule - Add": "قاعدة الإشعار - إضافة",
    "Notification Rule - Modify": "قاعدة الإشعار - تعديل",
    "Notification Rule - Delete": "قاعدة الإشعار - حذف",
    "Media Type - View": "وسائل الإشعار - عرض",
    "Media Type - Add": "وسائل الإشعار - إضافة",
    "Media Type - Modify": "وسائل الإشعار - تعديل",
    "Media Type - Delete": "وسائل الإشعار - حذف",
    "Message Template - View": "قالب الرسالة - عرض",
    "Message Template - Add": "قالب الرسالة - إضافة",
    "Message Template - Modify": "قالب الرسالة - تعديل",
    "Message Template - Delete": "قالب الرسالة - حذف",
    "Event Pipeline - View": "أنبوب الأحداث - عرض",
    "Event Pipeline - Add": "أنبوب الأحداث - إضافة",
    "Event Pipeline - Modify": "أنبوب الأحداث - تعديل",
    "Event Pipeline - Delete": "أنبوب الأحداث - حذف",
    "Notification Settings - View": "إعدادات الإشعارات (إصدار قديم) - عرض",
    "Notification Templates - View": "قوالب الرسائل (إصدار قديم) - عرض",

    "Integrations": "مركز التكامل",
    "Data Source - View": "مصدر البيانات - عرض",
    "Component - View": "المكون - عرض",
    "Component - Add": "المكون - إضافة",
    "Component - Modify": "المكون - تعديل",
    "Component - Delete": "المكون - حذف",
    "Embedded Product - View": "تكامل الأنظمة - عرض",
    "Embedded Product - Add": "تكامل الأنظمة - إضافة",
    "Embedded Product - Modify": "تكامل الأنظمة - تعديل",
    "Embedded Product - Delete": "تكامل الأنظمة - حذف",

    "Organization": "المؤسسة والأفراد",
    "User - View": "المستخدم - عرض",
    "User - Add": "المستخدم - إضافة",
    "User - Modify": "المستخدم - تعديل",
    "User - Delete": "المستخدم - حذف",
    "Team - View": "الفريق - عرض",
    "Team - Add": "الفريق - إضافة",
    "Team - Modify": "الفريق - تعديل",
    "Team - Delete": "الفريق - حذف",
    "Business Group - View": "مجموعة الأعمال - عرض",
    "Business Group - Add": "مجموعة الأعمال - إضافة",
    "Business Group - Modify": "مجموعة الأعمال - تعديل",
    "Business Group - Delete": "مجموعة الأعمال - حذف",
    "Role - View": "الدور - عرض",
    "Role - Add": "الدور - إضافة",
    "Role - Modify": "الدور - تعديل",
    "Role - Delete": "الدور - حذف",

    "System Settings": "إعدادات النظام",
    "View Site Settings": "عرض إعدادات الموقع",
    "View Variable Settings": "عرض إعدادات المتغيرات",
    "View SSO Settings": "عرض إعدادات الدخول الموحد (SSO)",
    "View Alerting Engines": "عرض قائمة محركات التنبيه",
    "View Product Version": "عرض إصدار المنتج",

    "Some alert rules still in the BusiGroup": "لا تزال هناك قواعد تنبيه في مجموعة الأعمال",
    "Some alert mutes still in the BusiGroup": "لا تزال هناك قواعد حجب في مجموعة الأعمال",
    "Some alert subscribes still in the BusiGroup": "لا تزال هناك قواعد اشتراك في مجموعة الأعمال",
    "Some Board still in the BusiGroup": "لا تزال هناك لوحات بيانات في مجموعة الأعمال",
    "Some targets still in the BusiGroup": "لا تزال هناك كائنات مراقبة في مجموعة الأعمال",
    "Some recording rules still in the BusiGroup": "لا تزال هناك قواعد تسجيل في مجموعة الأعمال",
    "Some recovery scripts still in the BusiGroup": "لا تزال هناك نصوص إصلاح في مجموعة الأعمال",
    "Some target busigroups still in the BusiGroup": "لا تزال هناك مجموعات مراقبة في مجموعة الأعمال",

    "saved view not found": "العرض المحفوظ غير موجود",
    "saved view name is blank": "اسم العرض لا يمكن أن يكون فارغاً",
    "saved view page is blank": "صفحة العرض لا يمكن أن تكون فارغة",
    "saved view name already exists in this page": "يوجد عرض عام بنفس الاسم في هذه الصفحة بالفعل",
